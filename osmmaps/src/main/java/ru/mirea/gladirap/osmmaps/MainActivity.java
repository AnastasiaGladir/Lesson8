package ru.mirea.gladirap.osmmaps;

import androidx.appcompat.app.AppCompatActivity;

import android.os.Bundle;

import ru.mirea.gladirap.osmmaps.databinding.ActivityMainBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marker.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"МИРЭА Cтромынка, 20",
        ...
        marker.setTitle("МИРЭА Cтромынка 20");
        ...
        marker1.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker1, MapView mapView) {
                Toast.makeText(getApplicationContext(),"МИРЭА Проспект Вернадского",
                        Toast.LENGTH_SHORT).show();
                return true;
            }
        });
